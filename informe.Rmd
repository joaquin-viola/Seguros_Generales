...
print(xtable(tri2, type="latex", align="ccccccccccc", digits = 0, caption="Siniestros incurridos acumulados por año y por período transcurrido en pesos.", label = "tabla1"), caption.placement = "bottom", comment = FALSE, size="\\fontsize{8.5pt}{10pt}\\selectfont")
...
print(xtable(Exhibit, type="latex", align="ccccc", digits = 3, caption=".", label = "exhibit"), caption.placement = "bottom", comment = FALSE)
```
...
print(xtable(factores_q1, type="latex", align="cc", digits = 3, caption=".", label = "factores1"), caption.placement = "bottom", comment = FALSE)
...
plot(log(q-1) ~ dev.period, main="Extrapolación Log-lineal de los factores año a año")
abline(tail.model)
```
...
Nuestros factores de desarrollo serán los obtenidos normalmente hasta el momento $n-1=9$ y para $q_n=q_{10}$ se le asigna el valor de $\hat{Q_n}$ calculado que ya se mostró que para el último período de desarrollo era válida la equivalencia.
...
print(xtable(Exhibit2, type="latex", align="ccccc", digits = 3, caption=".", label = "exhibit2"), caption.placement = "bottom", comment = FALSE)

```

Se observa que al asignarle un factor de desarrollo acumulado mayor a 1 para el último período de desarrollo se obtiene que las reservas por IBNR aumentan aproximadamente en \$3.000.000 respecto al método clásico, que representa aproximadamente un aumento del \%5. 
...
mackTRI
#, results='asis'
#print(xtable(resumenMackTRI$Totals, type="latex", align="cc", digits = 2, caption=".", label = "origin"), caption.placement = "bottom", comment = FALSE)
```
...
print(xtable(factores_q, type="latex", align="cc", digits = 3, caption=".", label = "factores"), caption.placement = "bottom", comment = FALSE)
```
...
#matriz <- as.matrix(mackTRI$FullTriangle)

#print(xtable(resumenMackTRI$ByOrigin, type="latex", align="ccccccc", digits = 3, caption="Siniestros incurridos acumulados por año y por período #transcurrido en pesos.", label = "origin"), caption.placement = "bottom", comment = FALSE, size="\\fontsize{10.5pt}{10pt}\\selectfont")
```
...
print(xtable(resumenMackTRI$ByOrigin, type="latex", align="ccccccc", digits = 3, caption=".", label = "origin"), caption.placement = "bottom", comment = FALSE, size="\\fontsize{10.5pt}{10pt}\\selectfont")
```

```{r, echo=FALSE, message=FALSE,warning=FALSE, results='asis'}

print(xtable(resumenMackTRI$Totals, type="latex", align="cc", digits = 2, caption=".", label = "tot"), caption.placement = "bottom", comment = FALSE)
...
```{r, echo=FALSE, fig.pos="h", message=FALSE, warning=FALSE, results='asis'}
print(xtable(frac2, type="latex", align="ccccccccccc", digits = 4, caption="Proporción de siniestros incurridos que han sido pagos en cada período de desarrollo.", label = "tabla2"), caption.placement = "bottom", comment = FALSE, size="\\fontsize{11.5pt}{10pt}\\selectfont")
...
ggplot(fracframe, aes(x=dev, y=100*value)) + geom_point(alpha=1, size = 2) +
  ...
  theme_bw() +
  ylim(c(10,120))+
  labs(x="Periodo de Desarrollo", y="Porcentaje  P/I",caption="Porcentaje P/I por periodo de desarrollo la recta roja que une las medias")
...
ggplot(fracfullframe, aes(x=dev, y=100*value, alpha = Tipo)) + geom_point(size = 2) +
  ...
  theme_bw() +
  ylim(c(10,120))+
  labs(x="Periodo de Desarrollo", y="Porcentaje  P/I",caption="Porcentaje P/I por periodo de desarrollo la recta roja que une las medias para valores observados y proyectados")
```
...
print(xtable(summary(BayernMunich)$ByOrigin, type="latex", align="ccccccc", caption="", label = "origin2"), caption.placement = "bottom", comment = FALSE, size="\\fontsize{10pt}{10pt}\\selectfont")
...
#
print(xtable(summary(BayernMunich)$Totals, type="latex", align="cccc", digits = 3, caption=".", label = "totales"), caption.placement = "bottom", comment = FALSE)
```
